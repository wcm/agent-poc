...
This document defines the tagging schema for query intent.
...
```json
[
  {"category": "data_analysis", "topic": "creative_insights"},
  {"category": "recommendation", "topic": "creative_iteration"}
]
```
...
- Use `{"category": "other", "topic": "follow_up_clarification"}` when the question is primarily a follow‑up to prior context.
...
- "Can you send me emails of the top perfoming creative in the last 7 days?"
  - tags: `[{ "category": "action", "topic": "create_file" }]`
